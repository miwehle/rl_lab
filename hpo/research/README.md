...
- `lab_journal.md`: Chronological experiment notes, newest first.
- `insights.md`: Distilled Aha moments and lessons learned.
- `hypotheses.md`: Testable, action-guiding working hypotheses.
- `facts.md`: Empirical technical findings, measurements, and reusable rules of thumb.
