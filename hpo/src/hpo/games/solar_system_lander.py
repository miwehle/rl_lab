...
def _parse_args():
    ...
    parser.add_argument("--observation-mode", choices=["8d", "9d", "10d", "11d"], default="10d")
...
def _key(name: str) -> int:
    ...
    return {"up": pygame.K_UP, "left": pygame.K_LEFT, "right": pygame.K_RIGHT, "space": pygame.K_SPACE}[name]
